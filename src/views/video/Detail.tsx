...
import {Video, createVideo, UpUser, PartitionType} from "../../models";
...
class Detail extends React.Component<DetailProps, DetailState> {
    ...
    private defaultTabData: Array<PartitionType>;
    ...
    constructor(props) {
        ...
        this.defaultTabData = [{id: 0, name: "热门分享"} as PartitionType, {id: 1, name: "相关推荐"} as PartitionType,];
        this.commentPage = {
            pageNumber: 1,
            pageSize: 20,
            count: 0
    ...
    public render() {
        ...
        const tabBarData = this.defaultTabData.concat({
            id: 2,
            name: `评论${this.totalSize}`
        } as PartitionType);
        return (
            <div className="video-detail">
                ...
                <span>&gt;</span> */}
                    ...
                    <div className={style.tabBar}>
                        <TabBar data={tabBarData} type={"indicate"} currentIndex={this.state.currentTabIndex}
